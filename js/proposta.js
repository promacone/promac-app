...
import { el, render } from './ui.js?v=20260831170046'
...
export function prepararProposta() {
  if (!bibliotecaPronta) {
    bibliotecaPronta = import('./vendor/jspdf.umd.min.js?v=20260831170046')
...
function imprimirComoAntes(dados, empresa, numero, validade) {
  const folha = el('div', { classe: 'proposta' }, [
    el('div', { classe: 'proposta__topo' }, [
      el('img', { classe: 'proposta__logo', src: 'icones/logo.png?v=20260831170046', alt: 'PROMAC Transportes' }),
